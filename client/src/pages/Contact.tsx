...
export default function Contact() {
  ...
  const contactInfo = [
    { icon: 'fas fa-envelope', text: 'nhlayisekobvuma7@gmail.com' },
    { icon: 'fas fa-phone', text: '0647395070' },
    { icon: 'fas fa-map-marker-alt', text: 'Johannesburg, Soweto 1818' }
  ];
            ...
            <div className="bg-bg-light rounded-lg p-8 h-full">
              ...
              <div className="mt-10">
                ...
                <p className="text-base text-gray-medium">
                  Currently available for new opportunities. Let's work together to create something amazing!
                </p>
              </div>
            </div>
          </div>
